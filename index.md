# ggbenjamini ![](reference/figures/hex_sticker.png)
...
of a ficus benjamini. The main function is
...
![](reference/figures/README-def-1.png)
...
[`benjamini_leaf()`](https://urswilke.codeberg.page/ggbenjamini/reference/benjamini_leaf.md)
(if parameters are not explicitly specified), let’s only pass the
position of the leaf origins and let the function randomly generate the
rest of the shapes:
...
![](reference/figures/README-plotlotsofbenjamini-1.png)

## Branches

You can also generate branches of leaves with the command
[`benjamini_branch()`](https://urswilke.codeberg.page/ggbenjamini/reference/benjamini_branch.md)
(see the vignettes
[`vignette("create_benjamini_polygons")`](https://urswilke.codeberg.page/ggbenjamini/articles/create_benjamini_polygons.md)
and
[`vignette("create_benjamini_tree")`](https://urswilke.codeberg.page/ggbenjamini/articles/create_benjamini_tree.md)
for examples):
...
As the following plot also shows,
[`benjamini_branch()`](https://urswilke.codeberg.page/ggbenjamini/reference/benjamini_branch.md)
adds another column `i_leaf` specifying the index of the leaf on the
branch.
...
![](reference/figures/README-branch2-1.png)

## Polygons

If you want to fill the leaves with color, you can use
[`bezier_to_polygon()`](https://urswilke.codeberg.page/ggbenjamini/reference/bezier_to_polygon.md)
to approximate the bezier curves leaf parts with polygons:
...
![](reference/figures/README-polygon-1.png)
...
for an example to generate svg images.
